...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "cn.shuchan.boot";
    private static final String ARTIFACT_ID = "shuchan";
    private static final String PACKAGE_NAME = "cn.shuchan";
    private static final String TITLE = "数禅数源支付管理系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "cn.shuchan.boot";
        String artifactIdNew = "shuchan";
        String packageNameNew = "cn.shuchan";
        String titleNew = "数禅数源支付管理系统";
