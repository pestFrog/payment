...
import cn.shuchan.module.pay.controller.admin.order.vo.*;
...
public interface PayOrderConvert {
    ...
    PayOrderSubmitRespVO convert(PayOrderDO order, cn.shuchan.framework.pay.core.client.dto.order.PayOrderRespDTO respDTO);
