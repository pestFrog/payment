package cn.shuchan.module.infra.service.logger;
...
import cn.shuchan.module.infra.api.logger.dto.ApiErrorLogCreateReqDTO;
import cn.shuchan.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogPageReqVO;
import cn.shuchan.module.infra.dal.dataobject.logger.ApiErrorLogDO;
import cn.shuchan.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import cn.shuchan.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static cn.shuchan.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static cn.shuchan.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        ApiErrorLogDO apiErrorLogDO = randomPojo(ApiErrorLogDO.class, o -> {
            ...
            o.setApplicationName("shuchan-test");
            o.setRequestUrl("foo");
        ...
        reqVO.setApplicationName("shuchan-test");
