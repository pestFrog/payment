package cn.shuchan.module.infra.service.codegen.inner;
...
import cn.shuchan.framework.common.exception.util.ServiceExceptionUtil;
...
import cn.shuchan.framework.operatelog.core.enums.OperateTypeEnum;
...
public class CodegenEngine {
    ...
    private static String javaModuleFilePath(String path, String module, String src) {
        return "shuchan-module-${table.moduleName}/" + // 顶级模块
                "shuchan-module-${table.moduleName}-" + module + "/" + // 子模块
                "src/" + src + "/java/${basePackage}/module/${table.moduleName}/" + path + ".java";
    }

    private static String mapperXmlFilePath() {
        return "shuchan-module-${table.moduleName}/" + // 顶级模块
                "shuchan-module-${table.moduleName}-biz/" + // 子模块
    ...
    private static String vueFilePath(String path) {
        return "shuchan-ui-${sceneEnum.basePackage}-vue2/" + // 顶级目录
                "src/" + path;
    }
    ...
    private static String vue3FilePath(String path) {
        return "shuchan-ui-${sceneEnum.basePackage}-vue3/" + // 顶级目录
                "src/" + path;
    }
