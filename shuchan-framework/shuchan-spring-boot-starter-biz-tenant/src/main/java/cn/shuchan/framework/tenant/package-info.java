 ...
 *      1）Spring Async：
 *          {@link cn.shuchan.framework.quartz.config.ShuchanAsyncAutoConfiguration#threadPoolTaskExecutorBeanPostProcessor()}
 *      2）Spring Security：
 *          TransmittableThreadLocalSecurityContextHolderStrategy
 *          和 ShuchanSecurityAutoConfiguration#securityContextHolderMethodInvokingFactoryBean() 方法
 *
 */
package cn.shuchan.framework.tenant;
