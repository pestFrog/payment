package cn.shuchan.module.system.controller.admin.logger.vo.operatelog;
...
public class OperateLogRespVO {
    ...
    @Schema(description = "Java 方法名", requiredMode = Schema.RequiredMode.REQUIRED, example = "cn.shuchan.adminserver.UserController.save(...)")
