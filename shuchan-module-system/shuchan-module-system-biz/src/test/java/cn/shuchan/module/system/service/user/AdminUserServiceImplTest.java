package cn.shuchan.module.system.service.user;

import cn.hutool.core.util.RandomUtil;
import cn.shuchan.framework.common.enums.CommonStatusEnum;
import cn.shuchan.framework.common.exception.ServiceException;
import cn.shuchan.framework.common.pojo.PageResult;
import cn.shuchan.framework.common.util.collection.ArrayUtils;
import cn.shuchan.framework.common.util.collection.CollectionUtils;
import cn.shuchan.framework.test.core.ut.BaseDbUnitTest;
import cn.shuchan.module.infra.api.file.FileApi;
import cn.shuchan.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import cn.shuchan.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import cn.shuchan.module.system.controller.admin.user.vo.user.*;
import cn.shuchan.module.system.dal.dataobject.dept.DeptDO;
import cn.shuchan.module.system.dal.dataobject.dept.PostDO;
import cn.shuchan.module.system.dal.dataobject.dept.UserPostDO;
import cn.shuchan.module.system.dal.dataobject.tenant.TenantDO;
import cn.shuchan.module.system.dal.dataobject.user.AdminUserDO;
import cn.shuchan.module.system.dal.mysql.dept.UserPostMapper;
import cn.shuchan.module.system.dal.mysql.user.AdminUserMapper;
import cn.shuchan.module.system.enums.common.SexEnum;
import cn.shuchan.module.system.service.dept.DeptService;
import cn.shuchan.module.system.service.dept.PostService;
import cn.shuchan.module.system.service.permission.PermissionService;
import cn.shuchan.module.system.service.tenant.TenantService;
...
import static cn.shuchan.framework.common.util.collection.SetUtils.asSet;
import static cn.shuchan.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static cn.shuchan.framework.common.util.date.LocalDateTimeUtils.buildTime;
import static cn.shuchan.framework.common.util.object.ObjectUtils.cloneIgnoreId;
import static cn.shuchan.framework.test.core.util.AssertUtils.assertPojoEquals;
import static cn.shuchan.framework.test.core.util.AssertUtils.assertServiceException;
import static cn.shuchan.framework.test.core.util.RandomUtils.*;
import static cn.shuchan.module.system.enums.ErrorCodeConstants.*;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("shuchanyuanma");
        ...
        assertEquals("shuchanyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("shuchanyuanma"))).thenReturn("java");
