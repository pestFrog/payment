...
import cn.shuchan.framework.sms.config.ShuchanSmsAutoConfiguration;
import cn.shuchan.module.system.test.BaseDbAndRedisIntegrationTest;
...
// TODO @芋艿：需要迁移
@Import({ShuchanSmsAutoConfiguration.class,
