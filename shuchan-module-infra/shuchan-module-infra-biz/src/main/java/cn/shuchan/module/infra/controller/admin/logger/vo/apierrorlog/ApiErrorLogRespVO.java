package cn.shuchan.module.infra.controller.admin.logger.vo.apierrorlog;

import cn.shuchan.framework.excel.core.annotations.DictFormat;
import cn.shuchan.framework.excel.core.convert.DictConvert;
import cn.shuchan.module.infra.enums.DictTypeConstants;
...
public class ApiErrorLogRespVO {
    ...
    @DictFormat(cn.shuchan.module.system.enums.DictTypeConstants.USER_TYPE)
